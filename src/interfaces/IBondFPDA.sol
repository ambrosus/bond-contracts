...
import {IEngagementDiscountTierManager} from "../../lib/interfaces/IEngagementDiscountTierManager.sol";
...
interface IBondFPDA is IBondAuctioneer {
    ...
    /// @dev                    4. Deposit interval (seconds). Desired frequency of bonds. Used to calculate max payout
    /// of market (maxPayout = length / depositInterval * capacity).
    ...
    /// @dev                    8. Market scaling factor adjustment, ranges from -24 to +24 within the configured market
    /// bounds.
